...
class Coupons
{
    ...
    private ?CouponsTypes $coupons_type = null;
    ...
    public function getDescount(): ?int
    {
        return $this->descount;
    }

    public function setDescount(int $descount): static
    {
    ...
    public function setCouponsType(?CouponsTypes $coupons_type): static
    {
